  ...
  const SEED_EVENTS = [
    {
      ...
      distances: [
        { label: '11K', cutoff: '150', open: true },
        { label: '22K', cutoff: '270', open: true },
        { label: '29K', cutoff: '360', open: true },
      ],
    },
    {
      id: 'kk2026', name: 'Khao Kho Ultra 2026', date: '3 ส.ค. 2026', status: 'upcoming',
      closed: true, hotline: '',
      distances: [{ label: '22K', cutoff: '270', open: false }],
    },
    {
